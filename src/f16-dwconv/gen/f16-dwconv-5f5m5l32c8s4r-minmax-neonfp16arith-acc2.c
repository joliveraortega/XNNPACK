...
void xnn_f16_dwconv_minmax_ukernel_5f5m5l32c8s4r__neonfp16arith_acc2(
    size_t channels,
    size_t output_width,
    const void** input,
    const void* weights,
  ...
  do {
    ...
    // First pass to process 5 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        vst1q_u16(b, vacc01234567p0); b += 8;
        vst1q_u16(b, vacc89ABCDEFp0); b += 8;
        vst1q_u16(b, vaccGHIJKLMNp0); b += 8;
        vst1q_u16(b, vaccOPQRSTUVp0); b += 8;
      }
    ...
    // Last pass to process up to 5 inputs.
    {
      ...
      for (; c >= 32; c -= 32) {
        ...
        vst1q_u16(output, vacc01234567); output = (uint16_t*) output + 8;
        vst1q_u16(output, vacc89ABCDEF); output = (uint16_t*) output + 8;
        vst1q_u16(output, vaccGHIJKLMN); output = (uint16_t*) output + 8;
        vst1q_u16(output, vaccOPQRSTUV); output = (uint16_t*) output + 8;
      }
